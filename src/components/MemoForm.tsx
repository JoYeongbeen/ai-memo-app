          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className="flex-1 px-4 py-2 bg-blue-600 text-white hover:bg-blue-700 disabled:bg-blue-300 disabled:cursor-not-allowed rounded-lg transition-colors"
              >
                {isSubmitting ? '저장 중...' : editingMemo ? '수정하기' : '저장하기'}
              </button>
            </div>
          </form>
        </div>
